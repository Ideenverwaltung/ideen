...
export default function ProjectDetailPage() {
  ...
  async function deleteProject() {
    ...
    router.push(isIdea(project.status) ? "/ideen" : "/projekte");
  }

  const backHref = project && isIdea(project.status) ? "/ideen" : "/projekte";
  ...
  return (
    <div className="animate-in space-y-6">
      ...
      >
        <ArrowLeft size={15} /> {isIdea(project.status) ? "Alle Ideen" : "Alle Projekte"}
      </Link>
      ...
      <CurrentStateCard
        ...
        onSaved={(s) => setProject({ ...project, current_state: s })}
      />
